...
if (isset($_POST['submit'])) {
  ...
  $sql = mysqli_query($connection, "SELECT * FROM tb_users WHERE username='$user' AND password='$pass'");
  ...
  if ($cek > 0) {
    ...
    $_SESSION['tingkat_user'] = $data['id_tingkat_user'];
...
<head>
  ...
  <!-- icheck bootstrap -->
  <link rel="stylesheet" href="assets/bootstrap/css/icheck-bootstrap/icheck-bootstrap.min.css">
  <!-- Theme style -->
...
<body class="hold-transition login-page">
  <div class="login-box">
    ...
    <div class="card card-outline card-primary">
      ...
      <div class="card-body">
        <p class="login-box-msg">selamat datang di admin website banteran</p>
