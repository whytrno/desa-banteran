<?php 
	...
	$sql = mysqli_query($connection, "SELECT * FROM tb_users WHERE id_user='$_SESSION[id]'");
    ...
    <div class="col-lg-4 col-xs-12">
        <div class="card card-primary">
            ...
            <div class="card-body text-center">
                <img src="../assets/img/avatar/<?= $data['img']?>" class="img-rounded">
                <h5 class="mt-3 text-primary text-uppercase"><?= $data['nama_pengguna'] ?></h5>
                <?php 
					if($_SESSION['tingkat_user'] == 1) {
                        ...
                        <div class="col-lg-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="file" name="file" id="file" class="form-control"
                                    placeholder="Masukkan File" value="<?= $data['img'] ?>">
                            </div>
                        </div>
                        <div class="col-lg-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="pengguna" name="pengguna" id="pengguna" class="form-control"
                                    placeholder="Masukkan Nama Pengguna" value="<?= $data['nama_pengguna'] ?>">
                            </div>
                        </div>
                        <div class="col-lg-12 col-xs-12">
            ...
            <div class="card-body">
                <form method="POST" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-xs-12">
                            <div class="form-group">
                                <label for="tingkat_user">Tingkat User</label>
                                <select name="tingkat_user" id="tingkat_user" class="form-control">
...
<?php 
	...
	if(isset($_POST['submit'])) {
		...
		$sql= mysqli_query($connection, "SELECT * FROM tb_users WHERE id_user='$id'");
		$data = mysqli_fetch_array($sql);

			if(!empty($gambar)) {
				if(in_array($ekstensi, $ekstensi_boleh) === true) {
					if($ukuran < 2000000) {
						move_uploaded_file($file_tmp, '../assets/img/avatar'. $gambar);
						$sql = mysqli_query($connection, "UPDATE tb_users SET username='$user', password='$pass', nama_pengguna='$pengguna', img='$gambar' WHERE id_user='$id'");
 	...
 	if(isset($_POST['tambah'])) {
		...
		$file_tmp = $_FILES['file']['tmp_name'];
			...
			if(in_array($ekstensi, $ekstensi_boleh) === true) {
				if($ukuran < 2000000) {
					move_uploaded_file($file_tmp, '../assets/img/avatar/'. $gambar);
					$sql = mysqli_query($connection, "INSERT INTO tb_users VALUES ('', '$user', '$pass', '$pengguna', '$gambar', '$tingkat_user')");
